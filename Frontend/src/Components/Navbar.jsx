...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-white dark:text-slate-900 fixed top-0 left-0 right-0 z-50 ${sticky
          ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-500 dark:text-slate-500 duration-300 transition-all ease-in-out"
          : ""
        }`}>
          ...
          <div className='navbar-end space-x-3'>
            ...
            <div className='hidden md:block'>
              <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                <input type="text" className="grow outline-none dark:bg-white dark:text-slate-900" placeholder="Search" />
